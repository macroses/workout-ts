  ...
  <div class="challenge-task__list">
    ...
    >
      ...
      <div
        ...
        @click.stop="updateChallengeStatus(challenge.challengeDates, challenge.id, dates)"
        v-if="dayjs(dates.date.seconds * 1000).format('DD.MM.YYYY') === challengeDate.format('DD.MM.YYYY')"
        :style="[!dates.isComplete ? {'background-color': `rgba(${challenge.challengeColor}, 0.4)`} : {'background-color': `rgba(${challenge.challengeColor}, 1)`}]"
      >
